...
The goal is a foundation that can grow: USDT/USDC as additional payment assets, real KYC/AML/OTP flows, and mobile apps. Those are modeled in the schema but deliberately deferred, so v1 stays small enough to actually finish and prove out.
